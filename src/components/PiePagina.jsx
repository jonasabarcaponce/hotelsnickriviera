            ...
            <div className="mx-auto px-5 items-center max-w-[1200px]">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="mt-1">Teléfono: <a href="tel:+529842043171">+52 984 204 3171</a></p>
                        <p>Email: <a href="mailto:reservations@hotelnickelodeonriviera.com">reservations@hotelnickelodeonriviera.com</a></p>
                    </div>
                    <div>
                    ...
                    <div className="fixed bottom-10 right-10 z-50">
                        <a href="https://wa.me/5219842043171" className="bg-green-600 text-white px-8 py-2 font-bold rounded-2xl transition-opacity hover:opacity-80 flex items-center">
