        ...
        <header className="bg-white text-black relative px-5">
            <div className="mx-auto py-8 flex justify-between px-5 items-center max-w-[1200px]">
                ...
                <nav id="menu" className={`md:flex flex-col md:flex-row bg-white md:bg-transparent w-full md:w-auto space-y-5 md:space-y-0 md:space-x-5 font-bold items-start md:items-center p-5 md:p-0 shadow-md md:shadow-none absolute md:relative top-full left-0 md:top-0 md:left-auto z-50 ${isOpen ? 'block' : 'hidden'}`}>
                    ...
                    <a href="tel:+529842043171" className="block bg-nickelodeonOrange text-white px-8 py-2 rounded transition-opacity hover:opacity-80">Llamar</a>
                 </nav>
            </div>
        </header>
        ...
        >
            {imagesWithTitles.map((item, index) => (    
                <SwiperSlide key={index}>
                    <div className='relative py-10 md:py-36 px-5' id='inicio'>
                        <div className="mx-auto px-5 items-center max-w-[1200px]">
                            ...
                            <div className="container relative mx-auto">
                                ...
                                <div className="mt-8 flex space-x-4">                                        
                                    <a href="#habitaciones" className="bg-nickelodeonOrange text-white text-xs md:text-base px-4 md:px-8 py-2 rounded transition-opacity hover:opacity-80">Ver habitaciones</a>
                                    <a href="#reservar" className="bg-gray-300 text-black text-xs md:text-base px-4 md:px-8 py-2 rounded transition-opacity hover:opacity-80">Reservar</a>
                                </div>
                            </div>
                        </div>
                    </div>
